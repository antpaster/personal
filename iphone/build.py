...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ru.netris.streaming.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','RuNetrisStreamingModuleAssets.m')
...
def package_module(manifest,mf,config):
	...
	zf.close()
	os.rename(modulezip, 'dist/' + modulezip)
