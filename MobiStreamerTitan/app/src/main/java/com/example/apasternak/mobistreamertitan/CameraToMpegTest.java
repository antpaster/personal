...
public class CameraToMpegTest extends AndroidTestCase {
    ...
    public Camera2VideoFragment getCamera2VideoFragment() {
        return mCamera2VideoFragment;
    }

    private Camera2VideoFragment mCamera2VideoFragment = Camera2VideoFragment.newInstance();
...
//
////    private static Fragment mCamera2VideoFragment = new Fragment(); // todo init
...
//            cameraDevice.close();
//            mCameraDevice = null;
//            Activity activity = mCamera2VideoFragment.getActivity();
//            if (null != activity) {
//                activity.finish();
//            }
//        }
...
//    public static CameraToMpegTest newInstance() {
//        return new CameraToMpegTest();
//    }
...
//                        ErrorDialog.newInstance(mCamera2VideoFragment.getString(R.string.permission_request))
//                                .show(mCamera2VideoFragment.getChildFragmentManager(), FRAGMENT_DIALOG);
//                        break;
//                    }
//                }
//            } else {
...
//            }
//        } else {
//            mCamera2VideoFragment.onRequestPermissionsResult(requestCode, permissions, grantResults);
//        }
//    }
...
//            releaseSurfaceTexture(); // todo done in closeCamera()
            mCamera2VideoFragment.closeCamera();
        }
    }
...
////            setUpMediaRecorder();
//
//            prepareEncoder(mVideoSize.getWidth(), mVideoSize.getHeight(), 10000000);
//
//            SurfaceTexture texture = mTextureView.getSurfaceTexture();
//            assert texture != null;
//            texture.setDefaultBufferSize(mPreviewSize.getWidth(), mPreviewSize.getHeight());
...
//                    updatePreview();
//                    mCamera2VideoFragment.getActivity().runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            // UI
...
////            return;
////        }
//        final Activity activity = mCamera2VideoFragment.getActivity();
...
//
//            int orientation = mCamera2VideoFragment.getResources().getConfiguration().orientation;
