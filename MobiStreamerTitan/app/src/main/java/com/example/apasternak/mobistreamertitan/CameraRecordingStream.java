...
/**
 * Created by apasternak on 27.11.17.
 */
...
public class CameraRecordingStream {
    ...
    public Surface getCurrentFrameSurface() {
        return mCurrentFrameSurface;
    }
     ...
     */
    public synchronized void configure(Context context, Size size, boolean useMediaCodec, int bitRate) {
...
//        }
        ...
        String mediaFileName = /*mediaStorageDir.getPath()*/mContext.getExternalFilesDir(null).getAbsolutePath() + File.separator +
                "VID_" + timeStamp + ".mp4";
