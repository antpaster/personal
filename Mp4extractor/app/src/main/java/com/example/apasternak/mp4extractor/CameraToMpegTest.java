package com.example.apasternak.mp4extractor;
 ...
 */
public class CameraToMpegTest extends AndroidTestCase implements View.OnClickListener,
...
//    private Camera mCamera;
    ...
    private static Fragment mFragment = new Fragment(); // todo init
            ...
            if (grantResults.length == VIDEO_PERMISSIONS.length) {
                for (int result : grantResults) {
                    if (result != PackageManager.PERMISSION_GRANTED) {
                        ErrorDialog.newInstance(mFragment.getString(R.string.permission_request))
