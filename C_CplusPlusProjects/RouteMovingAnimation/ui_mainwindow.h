...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(877, 677);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        widget = new QWidget(centralWidget);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(9, 10, 861, 611));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        stopButton->setText(QApplication::translate("MainWindow", "Stop animation", nullptr));
        startButton->setText(QApplication::translate("MainWindow", "Start animation", nullptr));
    } // retranslateUi
